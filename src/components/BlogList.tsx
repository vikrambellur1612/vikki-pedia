...
function getSmartThumbnail(slug: string, body: string, title: string, tags: string[]): string {
  ...
  const knownImages: { [key: string]: string } = {
    ...
    // Personal posts that should use favicon.jpg
    'skipping-christmas': '/images/favicon.jpg',
    'choices-in-life': '/images/favicon.jpg',
    'missing-someone-special': '/images/favicon.jpg',
    'malatesh-long-lost-friend': '/images/favicon.jpg',
    'end-of-summer': '/images/favicon.jpg'
  }
  ...
  // Check for personal/reflection content that should use favicon.jpg
